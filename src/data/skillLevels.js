...
export const SKILL_LEVELS = [
  ...
  },
  {
    ...
    partA: {
      label: 'Part A: Home Quiz',
      questions: [
        { key: 'q1', text: 'What is your pivot foot, and what happens if you move it while holding the disc?' },
        { key: 'q2', text: 'What is a "dump" pass and when should you use it?' },
        { key: 'q3', text: 'When you fake, what do you do — and what must you NOT do?' },
        { key: 'q4', text: 'If you fake high, where should your real throw go? What about if you fake low?' },
      ],
    },
    partB: {
      label: 'Part B: Practice Evaluation',
      checkpoints: [
        { key: 'pivotFoot',         label: 'Name Pivot Foot',          description: 'Player correctly identifies their pivot foot (the planted foot — not throwing-hand side).' },
        { key: 'pivotPastMark',     label: 'Pivot Past Mark',          description: 'Uses free foot to step wide past a stationary defender without lifting pivot foot.' },
        { key: 'convincingFake',    label: 'Convincing Fake',          description: 'Full arm and body commitment on fake — looks like a real throw, disc not released.' },
        { key: 'fakeHighThrowLow',  label: 'Fake High / Throw Low',    description: 'Fakes high, defender moves up, delivers low throw through the gap.' },
        { key: 'threeComboReps',    label: '3 Fake + Throw Combos',    description: 'Completes 3 successful fake+pivot+throw combos with a partner acting as defender.' },
      ],
    },
    partnerRequired: false,
  },
